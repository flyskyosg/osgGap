...
osgGap.SceneInit.prototype.getCamera = function () {
	...
	cordova.exec(function(states){ console.log(states); webViewDefaultCamera = states; } , function(error) {console.log("osgGap webViewDefaultCamera error!");}, "osgGap", "getDefaultCamera", []);
...
osgGap.Camera.prototype.setClearColor = function (r, g, b) {
    ...
    console.log("webView setClearColor camera : " + this.ptr);
...
osgGap.Geode.prototype.getCube = function ( _pos, _size ) {
    ...
    console.log("Web layer getCube : " + this.ptr);
...
osgGap.Vec3 = function () {
	...
	var vec3Ptr;
	cordova.exec(function(states){ console.log(states); vec3Ptr = states;} , function(error) {console.log("osgGap createVec3 error!");}, "osgGap", "getVec3Node", []);
